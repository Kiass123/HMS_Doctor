<?php 
    ...
    $id = $_REQUEST['id'];
    $row = Prescription_info($id);
?>
<!DOCTYPE html>
<html>

   <body>
    <form method="POST" action="../controlers/editCheck.php" enctype="multipart/form-data">
           ...
           <tr>
            ...
            <tr>
                ...
                <td align="center">
								...
								<input type="text" name="medicine" value="<?=$row['medicine']?>"/></b><br><hr>
